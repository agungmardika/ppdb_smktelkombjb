...
@section('content')
    <div class=" shadow-lg mt-16 w-[1227px] ml-1 h-screen">
        <div class="bg-gray-500  py-3 rounded-t-lg">
            <span class="text-white text-2xl font-bold ml-10">Data Pendaftar</span>
        </div>
        <div class="my-4 space-x-[40rem] flex justify-end  mr-20">
            <div class="mt-2 justify-start ">
                <a href='{{ url('/table/pendaftar/create') }}' class="btn btn-primary mt-2" hidden>+ Tambah Data</a>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close text-4xl" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
