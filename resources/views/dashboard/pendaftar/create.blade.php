                    ...
                    <div class="rounded-t bg-white mb-0 px-6 py-4 ">
                        <div class="text-center mx-auto flex justify-between">
                            <h6 class=" text-xl font-bold">
                                Create Data Pendaftar
                            </h6>
                        </div>
                    </div>
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        <form action="{{ url('/table/pendaftar') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="text"
                                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                        name='no_wa_siswa' id="no_wa_siswa" value=" {{ Session::get('no_wa_siswa') }}">
                                </div>
                            </div>
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                            ...
                            <div class="w-full lg:w-4/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="file"
                                        ...
                                        value=" {{ Session::get('dokumen_akta') }}">
                                </div>
                            </div>
                    </div>
                    <div class="w-full lg:w-4/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            <input type="file"
                                class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                name='dokumen_ktp_ortu' id="dokumen_akta_ortu"
                                value=" {{ Session::get('dokumen_ktp_ortu') }}">
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
            ...
            <div class="w-full lg:w-12/12 px-4">
                <div class="relative w-full mb-3">
                    ...
                    <select name="status" id="status"
                        class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                        <option  value="{{ Session::get('status') }}">
                            {{ Session::get('status') }}</option>
